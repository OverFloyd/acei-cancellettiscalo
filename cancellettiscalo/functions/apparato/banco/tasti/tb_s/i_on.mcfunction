 ## CONTROLLARE TUTTI I CHECK D'ITINERARIO EFFETTUATI PRIMA DELL'APERTURA DEL SEGNALE (e che questo sia a VI)
...
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/itin/pdt/a/i-1/fase4_cons_dev
