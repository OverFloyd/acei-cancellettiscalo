...
## Esiste il controllo
## Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdb1b > GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/occ/1b
execute if score Cancelletti buffer matches 1 if score @p can_cdb1b = GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/lib/1b
