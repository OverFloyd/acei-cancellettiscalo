...
## Esiste il controllo
### Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdb1a > GLOBAL static_zero run function cancellettiscalo:apparato/ql/cdb/stato/1a_occ
execute if score Cancelletti buffer matches 1 if score @p can_cdb1a matches 0 run function cancellettiscalo:apparato/ql/enti/dev/switch_lb/1a
