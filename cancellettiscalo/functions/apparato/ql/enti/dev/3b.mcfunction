...
## Esiste il controllo
### Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdb3b > GLOBAL static_zero run function cancellettiscalo:apparato/ql/cdb/stato/3b_occ
execute if score Cancelletti buffer matches 1 if score @p can_cdb3b matches 0 run function cancellettiscalo:apparato/ql/enti/dev/switch_lb/3b
