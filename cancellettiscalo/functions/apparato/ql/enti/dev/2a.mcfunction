...
## Esiste il controllo
## Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdb2a > GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/occ/2a
execute if score Cancelletti buffer matches 1 if score @p can_cdb2a = GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/lib/2a
