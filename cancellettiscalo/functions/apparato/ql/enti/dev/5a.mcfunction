...
## Esiste il controllo
## Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdb5a > GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/occ/5a
execute if score Cancelletti buffer matches 1 if score @p can_cdb5a = GLOBAL static_zero run function cancellettiscalo:apparato/ql/enti/dev/lib/5a
