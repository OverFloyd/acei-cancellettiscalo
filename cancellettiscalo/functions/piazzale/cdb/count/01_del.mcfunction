...
execute if score @p can_cdb01 = GLOBAL static_zero run function cancellettiscalo:piazzale/cdb/bloc/01_lib

# Liberazione punto II
execute if score @p can_cdb01 = GLOBAL static_zero run function cancellettiscalo:apparato/ql/punti/ii_lib
