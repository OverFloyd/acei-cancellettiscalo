...
execute if score @p can_cdb5b = GLOBAL static_zero run function cancellettiscalo:piazzale/dev/bloc/5b_lib

## Ripresa controllo
execute if score @p can_cdb5b = GLOBAL static_zero run function cancellettiscalo:piazzale/dev/contr/regain/5b

# Liberazione punto 2
execute if score @p can_cdb5b = GLOBAL static_zero run function cancellettiscalo:apparato/ql/punti/2_lib
