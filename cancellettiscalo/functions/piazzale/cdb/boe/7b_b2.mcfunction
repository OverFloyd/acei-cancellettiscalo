...
### Controllo consenso -> itinerari che vogliono 7b rovescio di punta
#### IV-6
execute if block -133 67 44 lime_concrete if block -108 69 -2 lime_concrete run function global:motion/to_north_west
