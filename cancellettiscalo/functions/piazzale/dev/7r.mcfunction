...
# 7a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -136 70 39 rail[shape=north_east]

# 7b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -133 70 41 rail[shape=south_west]
