...
# 5a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -114 71 20 rail[shape=east_west]

# 5b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -116 71 17 rail[shape=east_west]
