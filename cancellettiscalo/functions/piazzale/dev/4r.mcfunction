...
# 4a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -55 71 14 rail[shape=north_west]

# 4b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -52 71 10 rail[shape=south_east]
