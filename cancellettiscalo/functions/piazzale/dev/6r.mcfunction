...
# 6a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -122 71 17 rail[shape=north_east]

# 6b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -124 71 14 rail[shape=south_west]
