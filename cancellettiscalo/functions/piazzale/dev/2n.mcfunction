...
# 2a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -76 71 17 rail[shape=east_west]

# 2b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -74 71 14 rail[shape=east_west]
