...
# 3a
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -84 71 20 rail[shape=east_west]

# 3b
## Check buffer
execute if score @p buffer_20 matches 1 run setblock -82 71 17 rail[shape=east_west]
