...
## Set buffer
execute store result score Cancelletti buffer if block -106 80 -8 air

# Check Tc D se non esiste il controllo
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/contr/check/8
...
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/cdb/count/check/8
execute if score Cancelletti buffer matches 0 run function cancellettiscalo:piazzale/dev/check/tb_d

# Manovra deviatoi
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/res/8r
