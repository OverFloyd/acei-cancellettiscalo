...
### It. 3-IV
## Check buffer
execute if score Cancelletti buffer matches 0 if block -113 69 -2 lime_concrete run function cancellettiscalo:piazzale/seg/f/asp/r

## It. 3-III
## Check buffer
execute if score Cancelletti buffer matches 0 if block -114 69 -2 lime_concrete run function cancellettiscalo:piazzale/seg/f/asp/r

### It. IV-4
## Check buffer
execute if score Cancelletti buffer matches 0 if block -106 69 -2 lime_concrete run function cancellettiscalo:piazzale/seg/i/asp/r

## It. III-4
## Check buffer
execute if score Cancelletti buffer matches 0 if block -103 69 -2 lime_concrete run function cancellettiscalo:piazzale/seg/j/asp/r
