...
## Set buffer
execute store result score Cancelletti buffer if block -119 76 -8 air if block -119 74 -8 air
...
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/cdb/count/check/2a
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/cdb/count/check/2b
