...
## Set buffer
function cancellettiscalo:piazzale/dev/check/2a_r
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/check/2b_r
...
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/pos/2a_n
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/pos/2b_n
...
## Check buffer
execute if score Cancelletti buffer matches 1 run schedule function cancellettiscalo:piazzale/dev/contr/2a_n 4s
execute if score Cancelletti buffer matches 1 run schedule function cancellettiscalo:piazzale/dev/contr/2b_n 5s
