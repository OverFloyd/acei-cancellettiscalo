...
## Set buffer
function cancellettiscalo:piazzale/dev/check/4a_r
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/check/4b_r
...
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/pos/4a_n
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/pos/4b_n
...
## Check buffer
execute if score Cancelletti buffer matches 1 run schedule function cancellettiscalo:piazzale/dev/contr/4a_n 4s
execute if score Cancelletti buffer matches 1 run schedule function cancellettiscalo:piazzale/dev/contr/4b_n 5s
