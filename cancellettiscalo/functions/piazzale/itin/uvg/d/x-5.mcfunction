...
execute if score Cancelletti buffer matches 1 run setblock -104 69 -2 red_concrete
...
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/dev/bloc/3b_lib
...
## Reset flag registrazione
execute if score Cancelletti buffer matches 1 run setblock -107 69 -2 red_concrete
