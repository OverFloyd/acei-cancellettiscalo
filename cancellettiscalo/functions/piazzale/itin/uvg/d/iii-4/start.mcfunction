...
## Check buffer
execute if score Cancelletti buffer matches 1 run setblock -103 69 -3 air
...
execute if score Cancelletti buffer matches 0 run function cancellettiscalo:apparato/ql/punti/4_lib
