...
## Posizione enti
## Set buffer
function cancellettiscalo:piazzale/itin/uvg/a/iii-5/fase4_cons_dev
...
## INIZIO FASE 5
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/itin/uvg/a/iii-5/fase5
