...
## 7b, 04, 6a, 5b, II, 3b
## Set buffer
execute store result score Cancelletti buffer if score @p can_cdb7b matches 0 if score @p can_cdb04 matches 0 if score @p can_cdb6a matches 0 if score @p can_cdb5b matches 0 if score @p can_cdbii matches 0 if score @p can_cdb3b matches 0
...
## INIZIO FASE 3
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/itin/uvg/a/iv-5/fase3
