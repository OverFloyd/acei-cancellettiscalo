...
## 5b, 6a, 04, 7b
### Set buffer
execute store result score Cancelletti buffer if score @p can_cdb5b matches 0 if score @p can_cdb6a matches 0 if score @p can_cdb04 matches 0 if score @p can_cdb7b matches 0
...
## Check buffer
execute if score Cancelletti buffer matches 1 if score @p can_cdbii = GLOBAL static_zero run function cancellettiscalo:piazzale/itin/uvg/a/2-iv/prev_it