...
## 5b, 6a, 7b
### Set buffer
execute store result score @p buffer_20 if block -116 71 17 rail[shape=east_west] if block -122 71 17 rail[shape=east_west] if block -133 70 41 rail[shape=north_south]
...
## Check buffer
execute if score @p buffer_20 matches 1 run function cancellettiscalo:apparato/ql/punti/2_off