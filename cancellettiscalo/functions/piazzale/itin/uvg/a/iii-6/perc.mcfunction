...
## 7a, 6b
### Set buffer
execute store result score @p buffer_20 if block -136 70 39 rail[shape=north_south] if block -124 71 14 rail[shape=east_west]
...
## Check buffer
execute if score @p buffer_20 matches 1 run function cancellettiscalo:apparato/ql/punti/iii_off