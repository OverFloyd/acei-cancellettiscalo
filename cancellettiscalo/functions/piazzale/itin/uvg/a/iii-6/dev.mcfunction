...
execute unless block -136 70 39 rail[shape=north_south] unless block -133 70 41 rail[shape=north_south] run function cancellettiscalo:piazzale/dev/7n_autom
