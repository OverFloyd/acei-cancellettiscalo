...
## 7a, 05, 6b, I
## Set buffer
execute store result score Cancelletti buffer if score @p can_cdb7a matches 0 if score @p can_cdb05 matches 0 if score @p can_cdb6b matches 0 if score @p can_cdbi matches 0
...
## INIZIO FASE 3
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/itin/uvg/a/iii-6/fase3
