...
## Libertà cdb
## 7a, 05, 6b, 6a, 5b, 5a, III (3a zona d'uscita)
## Set buffer
execute store result score Cancelletti buffer if score @p can_cdb7a matches 0 if score @p can_cdb05 matches 0 if score @p can_cdb6b matches 0 if score @p can_cdb6a matches 0 if score @p can_cdb5b matches 0 if score @p can_cdb5a matches 0 if score @p can_cdbiii matches 0 if score @p can_cdb3a matches 0
...
## INIZIO FASE 3
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:piazzale/itin/uvg/a/iii-4/fase3
