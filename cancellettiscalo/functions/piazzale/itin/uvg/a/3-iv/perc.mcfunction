...
## 5a, 5b, 6a, 7b
### Set buffer
execute store result score @p buffer_20 if block -114 71 20 rail[shape=north_east] if block -116 71 17 rail[shape=south_west] if block -122 71 17 rail[shape=east_west] if block -133 70 41 rail[shape=north_south]
...
## Check buffer
execute if score @p buffer_20 matches 1 run function cancellettiscalo:apparato/ql/punti/3_off