...
execute if score Cancelletti buffer matches 1 run setblock -125 69 -2 red_concrete
...
## Reset flag registrazione
execute if score Cancelletti buffer matches 1 run setblock -122 69 -2 red_concrete
