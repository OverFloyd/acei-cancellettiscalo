...
# 2a, 2b, 1a, 4a
## Check flag
execute store result score Cancelletti buffer unless block -119 76 -8 redstone_block unless block -119 74 -8 redstone_block unless block -120 74 -8 redstone_block unless block -121 74 -8 redstone_block
