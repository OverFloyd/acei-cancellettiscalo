...
execute if score Cancelletti buffer matches 1 unless block -74 69 14 white_concrete run function cancellettiscalo:piazzale/dev/2n_autom
...
execute if score Cancelletti buffer matches 1 unless block -55 69 14 white_concrete run schedule function cancellettiscalo:piazzale/dev/4n_autom 20
...
## INIZIO FASE 2
## Check flag
execute if score Cancelletti buffer matches 1 run schedule function cancellettiscalo:piazzale/itin/pdt/a/6-i/fase2 20
