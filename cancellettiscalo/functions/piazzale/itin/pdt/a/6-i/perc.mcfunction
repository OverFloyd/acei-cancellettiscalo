...
## 2b, 1a, 4a
### Set buffer
execute store result score Cancelletti buffer if block -74 71 14 rail[shape=east_west] if block -68 71 14 rail[shape=east_west] if block -55 71 14 rail[shape=east_west]
...
## Check buffer
execute if score Cancelletti buffer matches 1 run function cancellettiscalo:apparato/ql/punti/6_bloc