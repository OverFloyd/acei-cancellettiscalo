...
### Set buffer
execute store result score @p buffer_20 if block -66 71 17 rail[shape=east_west] if block -76 71 17 rail[shape=east_west] if block -82 71 17 rail[shape=south_east] if block -84 71 20 rail[shape=north_west] if block -114 71 20 rail[shape=east_west] if block -122 71 20 rail[shape=south_west] if block -124 71 23 rail[shape=north_east]
