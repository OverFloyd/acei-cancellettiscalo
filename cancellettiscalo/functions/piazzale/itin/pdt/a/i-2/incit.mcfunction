...
### Set buffer
execute store result score @p buffer_20 if block -126 69 -2 red_concrete
...
### Check buffer
execute if score @p buffer_20 matches 1 run function cancellettiscalo:piazzale/itin/common/seg/vi/d
...
## Punto finale libero
### Check buffer
execute if score @p buffer_20 matches 1 run function cancellettiscalo:apparato/ql/punti/check/2