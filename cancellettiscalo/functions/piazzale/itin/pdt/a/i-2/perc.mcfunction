...
### Set buffer
execute store result score @p buffer_20 if block -55 71 14 rail[shape=east_west] if block -68 71 14 rail[shape=east_west] if block -74 71 14 rail[shape=south_east] if block -76 71 17 rail[shape=north_west] if block -82 71 17 rail[shape=east_west] if block -116 71 17 rail[shape=east_west]
