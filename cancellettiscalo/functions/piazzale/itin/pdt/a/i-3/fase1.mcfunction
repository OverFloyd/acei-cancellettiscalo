...
## Set flag
function cancellettiscalo:apparato/ql/punti/check/3
...
execute if score Cancelletti buffer matches 1 unless block -82 69 17 light_blue_concrete run schedule function cancellettiscalo:piazzale/dev/3r_autom 30
execute if score Cancelletti buffer matches 1 unless block -114 69 20 white_concrete run schedule function cancellettiscalo:piazzale/dev/5n_autom 40
