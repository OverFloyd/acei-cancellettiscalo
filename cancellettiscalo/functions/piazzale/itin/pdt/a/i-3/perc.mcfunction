...
### Set buffer
execute store result score Cancelletti buffer if block -55 71 14 rail[shape=east_west] if block -68 71 14 rail[shape=east_west] if block -74 71 14 rail[shape=south_east] if block -76 71 17 rail[shape=north_west] if block -82 71 17 rail[shape=south_east] if block -84 71 20 rail[shape=north_west] if block -114 71 20 rail[shape=east_west] if block -122 71 20 rail[shape=south_west] if block -124 71 23 rail[shape=north_east]
