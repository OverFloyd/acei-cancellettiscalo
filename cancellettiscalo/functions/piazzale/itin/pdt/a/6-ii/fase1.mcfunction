...
execute if score Cancelletti buffer matches 1 unless block -68 69 14 light_blue_concrete run schedule function cancellettiscalo:piazzale/dev/1r_autom 10
